...
public class LifeInsurance {
    ...
    public static ArrayList<LifeInsurance> lifeInsurance = new ArrayList<LifeInsurance>();

    public LifeInsurance(int precio, String tipo, String userid, String ibanPaga) {
        this.precio = precio;
        this.tipo = tipo;
        this.userid = userid;
    ...
    public void basico() {
        ...
        if (bankAccountEncontrado instanceof DebitAccount) {
            ...
            if (debit.balance >= precio2) {
                ...
                LifeInsurance life = new LifeInsurance(50, "basico", userEncontrado.userid, debit.IBAN);
            ...
            if (credit.balance >= precio2) {
                ...
                LifeInsurance life = new LifeInsurance(50, "basico", userEncontrado.userid, credit.IBAN);
                lifeInsurance.add(life);
            } else {
    ...
    public void moderado() {
        ...
        if (bankAccountEncontrado instanceof DebitAccount) {
            ...
            if (debit.balance >= precio2) {
                debit.balance = -precio2;
                LifeInsurance life = new LifeInsurance(180, "basico", userEncontrado.userid, debit.IBAN);
                lifeInsurance.add(life);
            } else {
                System.out.println("Dinero insuficiente.");
            }
            ...
            if (credit.balance >= precio2) {
                credit.balance = - precio2;
                LifeInsurance life = new LifeInsurance(180, "basico", userEncontrado.userid, credit.IBAN);
                lifeInsurance.add(life);
            } else {
                double available = credit.balance - precio2;
                if (available < 0) {
    ...
    public void premium() {
        ...
        if (bankAccountEncontrado instanceof DebitAccount) {
            ...
            if (debit.balance >= precio2) {
                debit.balance = -precio2;
                LifeInsurance life = new LifeInsurance(300, "basico", userEncontrado.userid, debit.IBAN);
                lifeInsurance.add(life);
            } else {
                System.out.println("Dinero insuficiente.");
            }
            ...
            if (credit.balance >= precio2) {
                credit.balance = - precio2;
                LifeInsurance life = new LifeInsurance(300, "basico", userEncontrado.userid, credit.IBAN);
                lifeInsurance.add(life);
            } else {
                double available = credit.balance - precio2;
                if (available < 0) {
    ...
    static void comprobarYCobrarLife(LifeInsurance life) {

        if (life.getFechaSeguro().plusYears(1).isBefore(LocalDate.now())) {

            BankAccount cuenta = buscarCuenta(life.getIbanPaga());

            if (cuenta != null) {

                int precio = life.getPrecio();
                ...
                if (cuenta instanceof DebitAccount) {
                    ...
                    if (debit.balance >= precio) {
                        ...
                        life.setFechaSeguro(LocalDate.now());
